...
describe("User Controller Tests", () => {
    ...
    describe("createUser Controller", () => {
        it("should return 400 if input validation fails", async () => {
            const req = { body: { firstName: "John", lastName: "Doe", emailId: "invalid email" } } as Request;
        ...
        it("should return 400 if the user already exists", async () => {
            const req = { body: { firstName: "Jane", lastName: "Doe", emailId: "john.doe@example.com" } } as Request;
            const res = {} as Response;
            const next = jest.fn();
        ...
        it("should return 400 if the first name is invalid", async () => {
            const req = { body: { firstName: "John123", lastName: "Doe", emailId: "john.doe@example.com" } } as Request;
            const res = {} as Response;
            const next = jest.fn();
        ...
        it("should return 400 if required fields are missing", async () => {
            const req = { body: { firstName: "", lastName: "", emailId: "" } } as Request;
            const res = {} as Response;
            const next = jest.fn();
    ...
    describe("getUsers Controller", () => {
        ...
        it("should return a list of users when users are found", async () => {
            const mockUsers = [
                { _id: "1", firstName: "John", lastName: "Doe", emailId: "john@example.com", createdAt: Date.now() },
                { _id: "2", firstName: "Jane", lastName: "Doe", emailId: "jane@example.com", createdAt: Date.now() + 10 },
            ];
